...
export default function Hero() {
  return (
    <section
      id="inicio"
      className="min-h-screen flex items-center justify-center bg-[url('/quito.jpg')] bg-cover bg-center"
    >
      <div className="bg-black/70 p-14 rounded-3xl text-center max-w-3xl shadow-2xl border border-white/10">
        ...
        <button className="bg-amber-500 text-black px-8 py-3 rounded-full font-semibold hover:bg-amber-400 transition">
