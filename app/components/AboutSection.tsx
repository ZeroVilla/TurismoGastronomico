  ...
  return (
    <section className="py-24 max-w-6xl mx-auto px-6">
      ...
      <p className="text-lg text-white leading-relaxed">
        Quito es reconocida por su rica herencia gastronómica que combina influencias
        indígenas, coloniales y contemporáneas. Sus mercados tradicionales, restaurantes
